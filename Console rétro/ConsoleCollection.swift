...
class ConsoleCollection {
    ...
    func obtenirListe() -> [Console] {
        ...
        let nes = Console(nom: "NES", logo: "Logo NES", modele2: "Mini NES", debut: 1983, fin: 2003, unite: 61.91, hit: "Super Mario Bros", rgb: [131, 118, 255], desc: "La ou le Nintendo Entertainment System, couramment abrégée en NES, ou simplement appelée Nintendo est une console de jeux vidéo de salon de troisième génération fabriquée par l'entreprise japonaise Nintendo et distribuée à partir de 1985 (1987 en Europe).\nSon équivalent japonais est la Family Computer, ou Famicom, sortie quelques années avant, en 1983. En Corée du Sud, la NES porta le nom de Comboy.", histoire: "La console connut un succès mondial, ce qui aida à redynamiser l'industrie du jeu vidéo après le krach du jeu vidéo de 1983.\nL'histoire de la NES commence au Japon en 1981. Sa longévité est la plus importante de toutes les consoles (devant l'Atari 2600 et la PlayStation).\nEn France, la NES devait initialement être commercialisée en septembre 1987 en même temps que la Master System mais la livraison par bateau venant du Japon prit du retard. Elle ne sera ainsi commercialisée que vers la fin octobre 1987.", histoire2: "Au total, 1 251 jeux ont été développés pour la console, tous continents confondus.\nLe 14 juillet 2016, Nintendo annonce la sortie de la Nintendo Classic Mini une version modifiée de la console d'origine avec quelques différences notables : une taille réduite, une connexion HDMI, des connecteurs pouvant accueillir une Wiimote, une version modifiée de la manette d'origine ne se différenciant de cette dernière que par la connectique. 30 jeux pré-installés accompagnent la console.")
        liste.append(nes)
